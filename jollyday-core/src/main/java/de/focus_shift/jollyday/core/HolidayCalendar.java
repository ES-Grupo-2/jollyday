...
public enum HolidayCalendar {
  ...
  ANTARCTICA("AQ"), AFGHANISTAN("AF"), ALBANIA("AL"), ALGERIA("DZ"), ANDORRA("AD"), ANGOLA("AO"), ARGENTINA("AR"), ARMENIA("AM"), AUSTRALIA("AU"), AUSTRIA("AT"),
  BAHAMAS("BS"), BANGLADESH("BD"), BARBADOS("BB"), BELARUS("BY"), BELGIUM("BE"), BENIN("BJ"), BERMUDA("BM"), BOLIVIA("BO"), BOSNIA_HERZIGOWINA("BA"), BOTSWANA("BW"), BRAZIL("BR"), BRITISH_VIRGIN_ISLANDS("VG"), BULGARIA("BG"), BURUNDI("BI"), BURKINA_FASO("BF"),
  CAMEROON("CM"), CANADA(Locale.CANADA.getCountry()), CAPE_VERDE("CV"), CAYMAN_ISLANDS("KY"), CENTRAL_AFRICAN_REPUBLIC("CF"), CHAD("TD"), CHILE("CL"), COLOMBIA("CO"), CONGO("CD"), CONGO_REPUBLIC("CG"), COSTA_RICA("CR"), CROATIA("HR"), CUBA("CU"), CZECH_REPUBLIC("CZ"), CYPRUS("CY"),
  DENMARK("DK"), DJIBOUTI("DJ"), DOW_JONES_STOXX("DJ_STOXX"),
  ECUADOR("EC"), EGYPT("EG"), EL_SALVADOR("SV"), ERITREA("ER"), ESTONIA("EE"), ETHIOPIA("ET"),
  FINLAND("FI"), FAROE_ISLANDS("FO"), FALKLAND_ISLANDS("FK"), FRANCE(Locale.FRANCE.getCountry()),
  GEORGIA("GE"), GERMANY(Locale.GERMANY.getCountry()), GAMBIA("GM"), GABON("GA"), GHANA("GH"), GIBRALTAR("GI"), GUYANA("GY"), GUATEMALA("GT"), GUERNSEY("GG"), GREECE("GR"), GREENLAND("GL"), GUINEA("GN"),
  HAITI("HT"), HONDURAS("HN"), HONG_KONG("HK"), HUNGARY("HU"),
  ICELAND("IS"), INDIA("IN"), IVORY_COAST("CI"), IRELAND("IE"), ISLE_OF_MAN("IM"), ITALY(Locale.ITALY.getCountry()),
  JAMAICA("JM"), JAPAN("JP"), JERSEY("JE"), JORDAN("JO"),
  KAZAKHSTAN("KZ"), KENYA("KE"), KOSOVO("XK"), KYRGYZSTAN("KG"),
  LIBERIA("LR"), LESOTHO("LS"), LIBYA("LY"),
  LATVIA("LV"), LIECHTENSTEIN("LI"), LITHUANIA("LT"), LONDON_METAL_EXCHANGE("LME"), LUXEMBOURG("LU"),
  MACEDONIA("MK"), MADAGASCAR("MG"), MALAWI("MW"), MALI("ML"), MALTA("MT"), MAURITANIA("MR"), MONACO("MC"), MOROCCO("MA"), MAURITIUS("MU"), MEXICO("MX"), MOLDOVA("MD"), MONTENEGRO("ME"), MOZAMBIQUE("MZ"),
